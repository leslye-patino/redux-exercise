  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      <fieldset>
        <label>
          <p>Name</p>
          <input value={values.name} name="name" onChange={onFieldChange} />
        ...
        <label>
          <p>Password: </p>
          <input value={values.password} type="password" name="password" onChange={onFieldChange}/>
        </label>
        {errors.password && (
        ...
        <label>
          ...
          <input value={values.confirm} type="password" name="confirm" onChange={onFieldChange}/>
        </label>
        {errors.confirm && (
